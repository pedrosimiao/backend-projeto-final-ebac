...
class PostSerializer(serializers.ModelSerializer):
    ...
    retweet_id = serializers.IntegerField(write_only=True, required=False, allow_null=True)

    class Meta:
        model = Post
        fields = ["id", "user", "content", "url", "image", "video", "created_at", "retweet", "retweet_id"]
